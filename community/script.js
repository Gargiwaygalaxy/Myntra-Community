    ...
    function displayPosts() {
        ...
        posts[currentGroup].forEach((post, index) => {
            ...
            postElement.innerHTML = `
                ...
                <div class="actions">
                    <div class="icons">
                        <i class="far fa-heart" data-index="${index}" data-type="like"></i> <span>${post.likes}</span>
                        <i class="far fa-bookmark" data-index="${index}" data-type="bookmark"></i> <span>${post.bookmarks}</span>
                    </div>
